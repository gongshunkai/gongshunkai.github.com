...
jutil.extend(ScrollBar.prototype,{
  ...
  ClickCtrl:function(e){
	  if(e.clientY - this.Track[0].offsetTop < this.Handle.position().top || e.clientY - this.Track[0].offsetTop > this.Handle.position().top + this.handle_height){
	  	this.ScrollBy(e.clientY - this.Track[0].offsetTop > this.Handle.position().top ? this.handle_height : -this.handle_height);
	  }
  },
