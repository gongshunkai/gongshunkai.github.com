...
jutil.extend(NavBar.prototype,{
  initialize: function(container, options) {
	...
	this.nodeTitle = this.container.querySelectorAll('.title');
	this.nodeSection = this.container.querySelectorAll('.section');
  ...
  FSM:{
	expand:{
		buttonWasPressed:function(){
			var o = this.nodeTitle[this.index];
			o.querySelector('img').src = this.icon.arrowDown;
			o.setAttribute("title","expand");
	...
	collapse:{
		buttonWasPressed:function(){
			var o = this.nodeTitle[this.index];
			o.querySelector('img').src = this.icon.arrowUp;
			o.setAttribute("title","collapse");
